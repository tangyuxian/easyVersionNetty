package com.yihuizhi.tcpTest;

import com.yihuizhi.tcp.EventLoopGroup;
...
public class NioServer {
    public static void main(String[] args) throws IOException {
        ...
        //创建另外一个事件查询器
        EventLoopStart eventLoop = new EventLoopStart();

        //创建一事件查询器
        //EventLoopGroupStart eventLoopGroup = new EventLoopGroupStart();
